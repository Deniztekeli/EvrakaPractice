...
public class AmazonShopping_StepDefinitions {
    ...
    public void search_i_phone12() {
        amazonPage.searchBox.sendKeys("iphone12 256" + Keys.ENTER);
    }
    ...
    public void log_the_following_values_for_each_size_size_information_price_color_stock_status() {
        ...
        String info = amazonPage.modelName.getText() +
                "\nSize: " + amazonPage.memoryStorageCapacity.getText()  +
                "\nColor: " + amazonPage.color.getText()  +
                "\nPrice: " + amazonPage.price.getText()  +
